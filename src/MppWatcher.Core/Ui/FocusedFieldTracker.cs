...
public sealed class FocusedFieldTracker
{
    ...
    public FieldCommit? OnFocus(UiElementInfo? field, DateTimeOffset now)
    {
    ...
    private FieldCommit? Commit(string trigger)
    {
        ...
        return new FieldCommit(_field with { Value = _last }, trigger, Edited: true);
    }
}
